...
/**Arrasta todo o vetor multiplicando pelo multiplicador que é um numero
 * crescente e armazena o algarismo menos significativo no vetor. Além disso
 * armazenda todos os outros algarismos na sobra
 * @author Rubio Torres
 * @param  multiplicador int - numero crescente que vai multiplicar por cada
 * numero no vetor
 * @param  tamanho int - Tamanho do vetor
 * @param  multiplicando int* - Vetor que vai receber o numero e que contem o
 * numero já armazenado
 * @return int - Tamanho do vetor final
 */
...
/**Torna o multiplicando crescente de 0 ao numero desejado, além disso
 * inicializa as variaveis e o vetor
 * @author Rubio Torres
 * @param  e_multiplicando int - Numero desejado o fatorial
 * @param  fim int* - Vetor que vai receber o numero e que contem o numero já
 * armazenado
 * @return int - Tamanho do vetor final
 */
...
int p_deslocador(int e_multiplicando, int *fim) {
  ...
  for (multiplicador = *(fim) = tam_vetor = 1; multiplicador <= e_multiplicando;
       multiplicador++) {
